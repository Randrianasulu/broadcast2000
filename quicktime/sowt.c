...
static int sowt_get_work_buffer(quicktime_t *file, int track, long bytes)
{
...
static int quicktime_delete_codec_sowt(quicktime_audio_map_t *atrack)
{
...
static int quicktime_decode_sowt(quicktime_t *file,
					int16_t *output_i,
					float *output_f,
					long samples,
					int track,
...
static int quicktime_encode_sowt(quicktime_t *file,
							int16_t **input_i,
							float **input_f,
							int track,
							long samples)
...
/* Init public items */
	((quicktime_codec_t*)atrack->codec)->priv = calloc(1, sizeof(quicktime_sowt_codec_t));
	((quicktime_codec_t*)atrack->codec)->delete_acodec = quicktime_delete_codec_sowt;
	((quicktime_codec_t*)atrack->codec)->decode_video = 0;
	((quicktime_codec_t*)atrack->codec)->encode_video = 0;
	((quicktime_codec_t*)atrack->codec)->decode_audio = quicktime_decode_sowt;
	((quicktime_codec_t*)atrack->codec)->encode_audio = quicktime_encode_sowt;
