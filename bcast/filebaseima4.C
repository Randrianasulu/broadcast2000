...
int FileBase::ima4_decode_block(TWO *output, unsigned char *input)
{
...
int FileBase::ima4_encode_block(unsigned char *output, TWO *input, int step, int channel)
{
	int i, j, nibble;
	TWO *input_end = input + ima4_block_size;
	TWO *subinput;
	int buffer_advance = asset->channels;
